// 注意：如果是使用到 vue 框架中，需要在每个函数之前使用export function isValidateUsername，
// 1. 如果是纯HTML文件，请去掉 export关键字

/**
 * @param {Object} str 验证用户名
 */
